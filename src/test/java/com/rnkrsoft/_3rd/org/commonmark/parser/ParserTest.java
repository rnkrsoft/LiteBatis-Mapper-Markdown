...
import com.rnkrsoft._3rd.org.commonmark.renderer.html.HtmlRenderer;
import com.rnkrsoft._3rd.org.commonmark.testutil.TestResources;
...
public class ParserTest {
    ...
    public void ioReaderTest() throws IOException {
        ...
        Node document1;
        InputStreamReader reader = new InputStreamReader(input1, Charset.forName("UTF-8"));
        try{
    ...
    public void enabledBlockTypes() {
        ...
        Set<Class<? extends Block>> headersOnly = new HashSet<Class<? extends Block>>();
        headersOnly.add(Heading.class);
        parser = Parser.builder().enabledBlockTypes(headersOnly).build();
        document = parser.parse(given);
        assertThat(document.getFirstChild(), instanceOf(Heading.class));

        Set<Class<? extends Block>> noCoreTypes = new HashSet<Class<? extends Block>>();
