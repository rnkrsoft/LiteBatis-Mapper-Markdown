...
import com.rnkrsoft._3rd.org.commonmark.internal.util.Parsing;
import com.rnkrsoft._3rd.org.commonmark.node.*;
import com.rnkrsoft._3rd.org.commonmark.parser.InlineParser;
import com.rnkrsoft._3rd.org.commonmark.parser.InlineParserFactory;
import com.rnkrsoft._3rd.org.commonmark.parser.block.*;
...
public class DocumentParser implements ParserState {
    ...
    private static final Set<Class<? extends Block>> CORE_FACTORY_TYPES = new LinkedHashSet<Class<? extends Block>>(Arrays.asList(
            BlockQuote.class,
            Heading.class,
    ...
    static {
        Map<Class<? extends Block>, BlockParserFactory> map = new HashMap<Class<? extends Block>, BlockParserFactory>();
    ...
    private Set<BlockParser> allBlockParsers = new LinkedHashSet<BlockParser>();
